...
単純にものを移動させたい場合は、移動させたいデザインのコンポーネントをクリックして<br>ツールバーの移動を選択して青,赤,緑の矢印を引っ張れば全体的に移動すると思います。
<br><br>
...
<br>
直方体が出来ても透けていないと見えずらいので透けさせたいコンポーネントを選択してツールバーの<br>
...
USBポートの穴もこの操作で長方形を面に描いてプルで押し出せば貫通出来ると思います。
